...
def _normalize_to(to: Union[str, Sequence[str]]) -> List[str]:
    ...
    Args:
        to: Target conversion format(s). Can be 'sql', 'python', or a list
            of them.
...
def convert(
    ...
    *,
    ...
    """Convert a binary XGBoost / LightGBM model into SQL and/or Python.

    Args:
        model: The trained model object (XGBoost Booster/Classifier or LightGBM Booster/Classifier).
        to: Target format(s). One of 'sql', 'python', or a list of them.
            Defaults to "sql".
        ...
        compatible_mode: Whether generated SQL should recognize NaN in addition
            to NULL as missing. Generated Python is unaffected. Defaults to False.
